...
lob_t jwt_verify(lob_t token, lob_t key); // probably use exchange3_verify and have it recognize?
lob_t jwt_sign(lob_t token, lob_t key); // probably add self3_sign?
