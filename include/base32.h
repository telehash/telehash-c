...
size_t base32_encode_length(size_t rawLength); // includes null
...
char *base32_encode(const void *buf, size_t len); // mallocs, includes null
size_t base32_decode_into(const char *base32Buffer, size_t base32BufLen, void *_buffer);
void *base32_decode(const char *buf, size_t *outlen); // mallocs
#endif
