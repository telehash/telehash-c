...
chan_t chan_new(struct switch_struct *s, struct hashname_struct *to, char *type, uint32_t id);
...
void chan_reset(struct switch_struct *s, struct hashname_struct *to);
...
void chan_tick(struct switch_struct *s, struct hashname_struct *to);

// returns existing or creates new and adds to from
chan_t chan_in(struct switch_struct *s, struct hashname_struct *from, lob_t p);
