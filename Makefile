DOTC = src/hn.c src/packet.c src/path.c src/switch.c src/hnt.c src/util.c src/crypt_libtom.c src/xht.c
DOTH = src/hn.h src/packet.h src/path.h src/switch.h src/hnt.h src/util.h src/crypt.h src/xht.h
